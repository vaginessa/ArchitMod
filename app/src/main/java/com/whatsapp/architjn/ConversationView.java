...
public class ConversationView extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        cardView.setBackgroundColor(shp.getInt("architModFabBgColor", ColorStore.getFabBgColor()));
        ...
        pointX = Integer.parseInt(shp.getString("architModFabBgPosX", "500"));
        pointY = Integer.parseInt(shp.getString("architModFabBgPosY", "500"));
        ...
        ((FloatingActionButton) a.getChildAt(Integer.parseInt(one))).setColorNormal(shp.getInt("architModFabNormalColor", ColorStore.getFabColorNormal()));
        ((FloatingActionButton) a.getChildAt(Integer.parseInt(two))).setColorNormal(shp.getInt("architModFabNormalColor", ColorStore.getFabColorNormal()));
        ((FloatingActionButton) a.getChildAt(Integer.parseInt(three))).setColorNormal(shp.getInt("architModFabNormalColor", ColorStore.getFabColorNormal()));
        ((FloatingActionButton) a.getChildAt(Integer.parseInt(one))).setColorPressed(shp.getInt("architModFabPressedColor", ColorStore.getFabColorNormal()));
        ((FloatingActionButton) a.getChildAt(Integer.parseInt(two))).setColorPressed(shp.getInt("architModFabPressedColor", ColorStore.getFabColorNormal()));
        ((FloatingActionButton) a.getChildAt(Integer.parseInt(three))).setColorPressed(shp.getInt("architModFabPressedColor", ColorStore.getFabColorNormal()));
